...
def port(request, port):
	return render(request, 'thsdashboard/index.html', { 'out': '', 'table': '', 'scaninfo': '', 'scandetails': '', 'trhost': '' })
...
def details(request, address):
	...
	return render(request, 'thsdashboard/nmap_portdetails.html', r)
...
def about(request):
	...
	return render(request, 'thsdashboard/nmap_about.html', r)
